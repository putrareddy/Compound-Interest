...
class MainApp(App):
    def build(self):
        self.icon = 'icon.png'
        layout = BoxLayout(orientation='vertical', padding = (0,0,0,760), spacing = 1)
        ...
        self.principal = TextInput(multiline=False, size_hint= (1, .17), input_type = 'number', input_filter='float')
        ...
        self.start = TextInput(multiline=False, size_hint= (1, .17), input_type = 'number')
        ...
        self.end = TextInput(multiline=False, size_hint= (1, .17), input_type = 'number')
        ...
        self.rate = TextInput(multiline=False, size_hint= (1, .17), input_filter = 'float', input_type = 'number')
    ...
    def show(self,btn):
        ...
        try:
            time,Amount = self.program(self.principal,self.start,self.end,self.rate)
            popupLabel = Label(text=str(time)+" Days \nAmount : "+"  "+str(Amount))
